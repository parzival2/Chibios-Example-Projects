...
/*
 * Setup for Black STM32F4VET6 board.
 */

/*
 * Board identifier.
 */
#define BOARD_Black_STM32F4VET6
...
#define GPIOA_LED_D2                6U
#define GPIOA_LED_D3                7U
...
#define GPIOE_BUTTON_KEY1           3U
#define GPIOE_BUTTON_KEY0           4U
...
#define LINE_LED_D2                 PAL_LINE(GPIOA, 6U)
#define LINE_LED_D3                 PAL_LINE(GPIOA, 7U)
...
#define LINE_BUTTON_KEY1            PAL_LINE(GPIOE, 3U)
#define LINE_BUTTON_KEY0            PAL_LINE(GPIOE, 4U)
 ...
 * PA6  - LED_D2                    (output pushpull maximum).
 * PA7  - LED_D3                    (output pushpull maximum).
...
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_BUTTON_WKUP) |    \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOA_LED_D2) |        \
                                     PIN_MODE_OUTPUT(GPIOA_LED_D3) |        \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_BUTTON_WKUP) |\
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_LED_D2) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_LED_D3) |     \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_BUTTON_WKUP) |   \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOA_LED_D2) |        \
                                     PIN_OSPEED_HIGH(GPIOA_LED_D3) |        \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_BUTTON_WKUP) |\
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOA_LED_D2) |     \
                                     PIN_PUPDR_FLOATING(GPIOA_LED_D3) |     \
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_BUTTON_WKUP) |      \
                                     ...
                                     PIN_ODR_HIGH(GPIOA_LED_D2) |           \
                                     PIN_ODR_HIGH(GPIOA_LED_D3) |           \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_BUTTON_WKUP, 0U) |   \
                                     ...
                                     PIN_AFIO_AF(GPIOA_LED_D2, 0U) |        \
                                     PIN_AFIO_AF(GPIOA_LED_D3, 0U))
 ...
 * PE3  - BUTTON_KEY1               (input floating).
 * PE4  - BUTTON_KEY0               (input floating).
...
#define VAL_GPIOE_MODER             (PIN_MODE_INPUT(GPIOE_PIN0) |           \
                                     ...
                                     PIN_MODE_INPUT(GPIOE_BUTTON_KEY1) |    \
                                     PIN_MODE_INPUT(GPIOE_BUTTON_KEY0) |    \
...
#define VAL_GPIOE_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOE_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOE_BUTTON_KEY1) |\
                                     PIN_OTYPE_PUSHPULL(GPIOE_BUTTON_KEY0) |\
...
#define VAL_GPIOE_OSPEEDR           (PIN_OSPEED_HIGH(GPIOE_PIN0) |          \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOE_BUTTON_KEY1) |   \
                                     PIN_OSPEED_HIGH(GPIOE_BUTTON_KEY0) |   \
...
#define VAL_GPIOE_PUPDR             (PIN_PUPDR_PULLUP(GPIOE_PIN0) |         \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOE_BUTTON_KEY1) |\
                                     PIN_PUPDR_FLOATING(GPIOE_BUTTON_KEY0) |\
...
#define VAL_GPIOE_ODR               (PIN_ODR_HIGH(GPIOE_PIN0) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOE_BUTTON_KEY1) |      \
                                     PIN_ODR_HIGH(GPIOE_BUTTON_KEY0) |      \
...
#define VAL_GPIOE_AFRL              (PIN_AFIO_AF(GPIOE_PIN0, 0U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOE_BUTTON_KEY1, 0U) |   \
                                     PIN_AFIO_AF(GPIOE_BUTTON_KEY0, 0U) |   \
