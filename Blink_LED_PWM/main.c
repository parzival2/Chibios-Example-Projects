...
static PWMConfig pwmCFG =
{
   ...
   100000,                   /* PWM period = ticks / PWM clock frequency */
   NULL,                    /* No callback */
   /*
    * Enable all channels
    */
...
int main(void) {
   ...
   */
  pwmEnableChannel(&PWMD4, 0, PWM_PERCENTAGE_TO_WIDTH(&PWMD4, 10));
  /*
   * Enable channel 1 with 25% duty cycle
   */
  pwmEnableChannel(&PWMD4, 1, PWM_PERCENTAGE_TO_WIDTH(&PWMD4,25));
  /*
   * Enable channel 2 with 50% duty cycle
   */
  pwmEnableChannel(&PWMD4, 2, PWM_PERCENTAGE_TO_WIDTH(&PWMD4, 50));
  /*
   * Enable channel 3 with 10% duty cycle
   */
  pwmEnableChannel(&PWMD4, 3, PWM_PERCENTAGE_TO_WIDTH(&PWMD4, 80));
